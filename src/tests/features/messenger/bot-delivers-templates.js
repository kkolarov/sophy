...
//
// describe("The bot delivers templates", () => {
//
//   before('A database configuration.', (done) => {
//     mongoose.connect(config.get('database').get('mongoUri'), (err, res) => {
//       if (!err) {
//         done();
//       }
//     });
...
//     this.messenger.setAccessToken(config.get('services').get('facebook').get('pageAccessToken'));
//   });
//
